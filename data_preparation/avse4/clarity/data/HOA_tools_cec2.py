...
def binaural_mixdown(
    ...
    hrir_data = hrir["M_data"][:, hrir_metadata["selected_channels"], :]  #HRIR of selected channels/directions for left/right signals
    ...
    #cut stereo_audio signal to have same number of samples as target signal
    hrir_length = hrir_data.shape[0]
    stereo_audio = stereo_audio[:-hrir_length+1, :]
